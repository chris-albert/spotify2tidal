    ...
    <div className={`bg-white rounded-lg shadow-lg p-6 ${className}`}>
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-sm font-bold text-gray-900">{unmatched}</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
            <div
      ...
      <div className="grid grid-cols-2 gap-3 mt-6">
        <div className="bg-green-50 border border-green-200 rounded-lg p-3">
          <p className="text-xs text-green-700 font-medium mb-1">Matched</p>
          <p className="text-2xl font-bold text-green-900">{totalMatched}</p>
        </div>
        <div className="bg-red-50 border border-red-200 rounded-lg p-3">
          <p className="text-xs text-red-700 font-medium mb-1">Unmatched</p>
          <p className="text-2xl font-bold text-red-900">{unmatched}</p>
        </div>
      </div>
    </div>
  )
